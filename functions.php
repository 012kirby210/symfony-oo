...
//    $ship2->setName('cloakshape_fighter');
    $ship2->setWeaponPower( 2);
    $ship2->setJediFactor( 2);
    $ship2->setStrength(70);

    $ship3 = new Ship('cloakshape_fighter');
//    $ship3->setName('super_star_destroyer');
    $ship3->setWeaponPower( 70);
    $ship3->setJediFactor( 0);
    $ship3->setStrength(500);

    $ship4 = new Ship('cloakshape_fighter');
//    $ship4->setName('rz1_a_wing_interceptor');
    ...
    return [
        'starfighter' => $ship,
        'cloakshape_fighter' => $ship2,
        'super_star_destroyer' => $ship3,
        'rz1_a_wing_interceptor' => $ship4
    ];
